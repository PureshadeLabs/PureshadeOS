...
impl Error {
    ...
    pub fn from_kernel(e: lythos_rt::SysError) -> Self {
        let kind = match e {
            lythos_rt::SysError::NoCap  => ErrorKind::PermissionDenied,
            lythos_rt::SysError::NoPerm => ErrorKind::PermissionDenied,
            lythos_rt::SysError::Inval  => ErrorKind::InvalidInput,
            _                            => ErrorKind::Other,
        };
        Error { kind, msg: None }
    }
