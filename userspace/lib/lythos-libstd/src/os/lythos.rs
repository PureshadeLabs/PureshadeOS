...
pub use lythos_rt::cap::{CapHandle, Rights};
pub use lythos_rt::ipc::{Endpoint, Channel, Message, MSG_SIZE};
pub use lythos_rt::SysError;

// Boot info — BootInfo is at the lythos_rt crate root (no boot submodule).
pub use lythos_rt::BootInfo;
